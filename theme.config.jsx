...
export default {
  ...
  project: {
    link: "https://github.com/whywasmyapprejected/whywasmyapprejected-com",
  },
  chat: {
    link: "https://twitter.com/whyapprejected",
    icon: (
      <svg
  ...
  docsRepositoryBase:
    "https://github.com/whywasmyapprejected/whywasmyapprejected-com/tree/main/",
  footer: {
    text: (
      <span>
